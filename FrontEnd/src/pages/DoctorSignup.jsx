    ...
    <div className="min-h-screen flex font-sans">
      ...
      {showAckModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
          <div className="bg-white rounded-3xl shadow-2xl w-full max-w-2xl max-h-[90vh] flex flex-col fade-up overflow-hidden">
            {/* Header */}
            <div className="bg-[#0A2540] px-8 py-5 flex items-center gap-3">
              <div className="w-10 h-10 rounded-full bg-[#00B4A0]/20 flex items-center justify-center flex-shrink-0">
                <svg className="w-5 h-5 text-[#00B4A0]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                </svg>
              </div>
              <div>
                <h2 className="text-white text-lg font-extrabold">Community Guidelines</h2>
                <p className="text-slate-400 text-xs">Please review our terms before joining</p>
              </div>
              <button
                type="button"
                onClick={() => { setShowAckModal(false); setAgreedToTerms(false); }}
                className="ml-auto w-8 h-8 rounded-full bg-white/10 hover:bg-white/20 flex items-center justify-center text-slate-300 hover:text-white transition flex-shrink-0"
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex-1 overflow-y-auto px-8 py-6 space-y-6">
              <p className="text-slate-600 text-sm leading-relaxed">
                Before we process your registration, please carefully read and acknowledge the following guidelines that govern our medical community. By agreeing, you confirm your commitment to maintaining the highest standards of care and professionalism.
              </p>
              ...
              <div className="space-y-4">
                <div className="flex gap-4 p-4 rounded-2xl bg-slate-50 border border-slate-100">
                  <span className="w-8 h-8 rounded-full bg-amber-100 flex items-center justify-center flex-shrink-0 mt-0.5">
                    <span className="text-amber-600 text-sm font-extrabold">1</span>
                  </span>
                  <div>
                    <h4 className="text-sm font-extrabold text-[#0A2540]">Consultation Fee Sharing</h4>
                    <p className="text-xs text-slate-500 mt-1 leading-relaxed">
                      A <span className="font-bold text-slate-700">10% platform fee</span> will be deducted from every completed consultation. This covers patient acquisition, infrastructure, AI-powered tools, and ongoing technical support.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4 p-4 rounded-2xl bg-slate-50 border border-slate-100">
                  <span className="w-8 h-8 rounded-full bg-amber-100 flex items-center justify-center flex-shrink-0 mt-0.5">
                    <span className="text-amber-600 text-sm font-extrabold">2</span>
                  </span>
                  <div>
                    <h4 className="text-sm font-extrabold text-[#0A2540]">Conduct & Community Standards</h4>
                    <p className="text-xs text-slate-500 mt-1 leading-relaxed">
                      All interactions with patients must be respectful, professional, and ethical. If we receive <span className="font-bold text-slate-700">verified complaints</span> from patients regarding unprofessional behavior, misconduct, or negligence, your account may be <span className="font-bold text-red-500">permanently removed</span> from the platform.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4 p-4 rounded-2xl bg-slate-50 border border-slate-100">
                  <span className="w-8 h-8 rounded-full bg-amber-100 flex items-center justify-center flex-shrink-0 mt-0.5">
                    <span className="text-amber-600 text-sm font-extrabold">3</span>
                  </span>
                  <div>
                    <h4 className="text-sm font-extrabold text-[#0A2540]">Licence & Credential Verification</h4>
                    <p className="text-xs text-slate-500 mt-1 leading-relaxed">
                      Your registration will only be approved if your <span className="font-bold text-slate-700">medical licence is active</span> and the degree or licence document you upload is verified as <span className="font-bold text-slate-700">legitimate and current</span>. Fraudulent or expired credentials will result in immediate rejection.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4 p-4 rounded-2xl bg-slate-50 border border-slate-100">
                  <span className="w-8 h-8 rounded-full bg-amber-100 flex items-center justify-center flex-shrink-0 mt-0.5">
                    <span className="text-amber-600 text-sm font-extrabold">4</span>
                  </span>
                  <div>
                    <h4 className="text-sm font-extrabold text-[#0A2540]">Patient Confidentiality & Data Privacy</h4>
                    <p className="text-xs text-slate-500 mt-1 leading-relaxed">
                      You are required to maintain strict confidentiality of all patient information. Sharing patient data outside the platform, recording consultations without consent, or any breach of privacy will result in <span className="font-bold text-red-500">immediate account termination</span> and may be reported to relevant authorities.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4 p-4 rounded-2xl bg-slate-50 border border-slate-100">
                  <span className="w-8 h-8 rounded-full bg-amber-100 flex items-center justify-center flex-shrink-0 mt-0.5">
                    <span className="text-amber-600 text-sm font-extrabold">5</span>
                  </span>
                  <div>
                    <h4 className="text-sm font-extrabold text-[#0A2540]">Profile & Schedule Accuracy</h4>
                    <p className="text-xs text-slate-500 mt-1 leading-relaxed">
                      You are responsible for keeping your profile information, availability, and fees up to date. Repeated <span className="font-bold text-slate-700">last-minute cancellations</span>, no-shows, or discrepancies between listed and actual fees may lead to account suspension.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4 p-4 rounded-2xl bg-slate-50 border border-slate-100">
                  <span className="w-8 h-8 rounded-full bg-amber-100 flex items-center justify-center flex-shrink-0 mt-0.5">
                    <span className="text-amber-600 text-sm font-extrabold">6</span>
                  </span>
                  <div>
                    <h4 className="text-sm font-extrabold text-[#0A2540]">Platform Rules Compliance</h4>
                    <p className="text-xs text-slate-500 mt-1 leading-relaxed">
                      You agree to use the platform solely for legitimate medical consultations. Soliciting patients for off-platform payments, sharing contact details for private practice, or any misuse of the platform is strictly prohibited and will result in <span className="font-bold text-red-500">permanent removal</span>.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-amber-50 border border-amber-100 rounded-2xl p-4 flex gap-3">
                ...
                <p className="text-amber-700 text-xs font-medium leading-relaxed">
                  These guidelines are subject to updates. You will be notified of any material changes via the email address you registered with.
                </p>
              </div>
            </div>

            {/* Footer */}
            <div className="border-t border-slate-100 px-8 py-5 flex items-center justify-between gap-4 bg-slate-50/50">
              <label className="flex items-center gap-3 cursor-pointer select-none group flex-1">
                <div className="relative">
                  ...
                  <div className={`w-5 h-5 rounded border-2 flex items-center justify-center transition-all duration-200 ${
                    agreedToTerms
                      ? 'bg-[#00B4A0] border-[#00B4A0]'
                      : 'border-slate-300 group-hover:border-[#00B4A0]/50 bg-white'
                  }`}>
                    {agreedToTerms && (
                ...
                <span className="text-sm font-semibold text-slate-600 group-hover:text-[#0A2540] transition-colors">
                  I have read and agree to all the above guidelines
                </span>
              </label>
              ...
              <button
                ...
                onClick={handleAckProceed}
                className="px-8 py-3 rounded-xl bg-[#00B4A0] text-white font-bold text-sm hover:bg-teal-400 transition-all duration-200 disabled:opacity-40 disabled:cursor-not-allowed flex items-center gap-2 shadow-lg shadow-[#00B4A0]/20 whitespace-nowrap"
              >
                Next
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
