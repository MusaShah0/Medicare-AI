...
export default function NotificationBell({ role, light }) {
    ...
    <div ref={wrapperRef} style={{ position: 'relative', display: 'inline-block' }}>
      ...
      <button
        ...
        style={{
          ...
          color: light ? '#64748B' : 'rgba(255,255,255,0.7)',
          transition: 'color 0.2s, background 0.2s',
        }}
        onMouseEnter={e => { e.currentTarget.style.background = light ? 'rgba(0,0,0,0.05)' : 'rgba(255,255,255,0.1)'; e.currentTarget.style.color = light ? '#0A2540' : '#fff'; }}
        onMouseLeave={e => { e.currentTarget.style.background = 'transparent'; e.currentTarget.style.color = light ? '#64748B' : 'rgba(255,255,255,0.7)'; }}
      ...
      >
        ...
        {unread > 0 && (
          <span style={{
            ...
            padding: '0 3px',
            lineHeight: '1',
            border: light ? '1.5px solid #fff' : '1.5px solid #0A2540',
          }}>
            {badgeCount}
          </span>
        )}
